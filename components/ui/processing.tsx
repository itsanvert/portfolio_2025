...
export const ProcessingWithText = ({
  text = "Loading...",
  size = "md",
  className = "",
}: {
...
export const LoadingOverlay = ({
  ...
  return (
    ...
    >
      <ProcessingWithText text={text} size={gifSize} />
    </motion.div>
  );
};
  ...
  return (
    <div className={`relative ${className}`}>
      {isLoading && (
        ...
        >
          <ProcessingWithText text={loadingText} size="md" />
        </motion.div>
      )}
...
export const PageLoader = ({
  ...
  return (
    <LoadingContainer fullScreen>
      <ProcessingWithText text={text} size={size} />
    </LoadingContainer>
  );
};
